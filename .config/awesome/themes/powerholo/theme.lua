...
local theme                                     = {}
theme.dir                                       = os.getenv("HOME") .. "/.config/awesome/themes/powerholo"
...
-- Binary clock
--[[local binclock = require("themes.powerholo.binclock"){
    height = 16,
    show_seconds = true,
...
local clockbg = wibox.container.background(mytextclock, "#777E76" --[[theme.bg_focus--]], gears.shape.rectangle)
...
function theme.at_screen_connect(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            --wibox.container.background(wibox.container.margin(clockwidget, 4, 8), "#777E76"),
            --wibox.container.background(wibox.container.margin(clockbg, 4, 8), "#777E76"),
            --wibox.container.background(clockwidget, "#777E76"),
	    --clockwidget,
            clockbg,
            arrow("#777E76", "alpha"),
            --]]
